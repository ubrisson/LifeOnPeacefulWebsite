...
__webpack_require__(/*! css/application.css */ "./app/javascript/css/application.css");
...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(116:5) `@apply` cannot be used with `.\\/` because `.\\/` either cannot be found, or its actual definition includes a pseudo-selector like :hover, :active, etc. If you're sure that `.\\/` exists, make sure that any `@import` statements are being properly processed *before* Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  114 | \n  115 | blockquote {\n> 116 |     @apply bg-indigo-100 text-blue-900 rounded shadow-md text-center font-serif p-2 w-3 / 4 my-2 self-center\n      |     ^\n  117 | }\n  118 | \n");
...
/******/ });
//# sourceMappingURL=application-b2e0b3470bdf4542e1d8.js.map