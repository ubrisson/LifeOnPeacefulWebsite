...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(99:5) `@apply` cannot be used with `.border-r-3` because `.border-r-3` either cannot be found, or its actual definition includes a pseudo-selector like :hover, :active, etc. If you're sure that `.border-r-3` exists, make sure that any `@import` statements are being properly processed *before* Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n   97 | \n   98 | .current {\n>  99 |     @apply text-blue-900 border-t-2 border-b-2 border-l-2 border-r-3 not-italic;\n      |     ^\n  100 | }\n  101 | \n");
...
/******/ });
//# sourceMappingURL=application-62a205d6e57f029fb4a9.js.map