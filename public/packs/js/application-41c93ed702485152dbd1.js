...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(14:5) `@apply` cannot be used with `.min-h-screen` because `.min-h-screen` either cannot be found, or its actual definition includes a pseudo-selector like :hover, :active, etc. If you're sure that `.min-h-screen` exists, make sure that any `@import` statements are being properly processed *before* Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  12 | \n  13 | main {\n> 14 |     @apply min-h-screen mx-auto max-w-4xl ;\n     |     ^\n  15 |     @apply bg-gray-100;\n  16 |     @apply border border-gray-400 shadow-lg rounded-lg;\n");
...
/******/ });
//# sourceMappingURL=application-41c93ed702485152dbd1.js.map