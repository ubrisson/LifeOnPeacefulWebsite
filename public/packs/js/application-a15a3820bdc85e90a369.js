...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(99:5) `@apply` cannot be used with `.hover\\:bg-gray-200` because `.hover\\:bg-gray-200` either cannot be found, or its actual definition includes a pseudo-selector like :hover, :active, etc. If you're sure that `.hover\\:bg-gray-200` exists, make sure that any `@import` statements are being properly processed *before* Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n   97 | \n   98 | .previous-page {\n>  99 |     @apply relative block py-2 px-3 leading-tight bg-white text-blue-700 ml-0 rounded-l hover:bg-gray-200;\n      |     ^\n  100 | }\n  101 | .current {\n");
...
/******/ });
//# sourceMappingURL=application-a15a3820bdc85e90a369.js.map