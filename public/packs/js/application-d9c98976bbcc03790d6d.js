...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(100:5) `@apply` cannot be used with `.bg-wite` because `.bg-wite` either cannot be found, or its actual definition includes a pseudo-selector like :hover, :active, etc. If you're sure that `.bg-wite` exists, make sure that any `@import` statements are being properly processed *before* Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n   98 | .previous_page, .next_page, .current, .pagination > a {\n   99 |     @apply relative block py-2 px-3 leading-tight text-blue-900 ml-0 no-underline;\n> 100 |     @apply bg-wite font-semibold;\n      |     ^\n  101 | }\n  102 | \n");
...
/******/ });
//# sourceMappingURL=application-d9c98976bbcc03790d6d.js.map