...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(17:5) `@apply` cannot be used with `.min-h-3` because `.min-h-3` either cannot be found, or its actual definition includes a pseudo-selector like :hover, :active, etc. If you're sure that `.min-h-3` exists, make sure that any `@import` statements are being properly processed *before* Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  15 | \n  16 | main {\n> 17 |     @apply min-h-3 / 4 mx-auto bg-gray-100 max-w-4xl border rounded-lg shadow-xl my-6 pb-8;\n     |     ^\n  18 | }\n  19 | \n");
...
/******/ });
//# sourceMappingURL=application-44dbea10380ea65ac84c.js.map